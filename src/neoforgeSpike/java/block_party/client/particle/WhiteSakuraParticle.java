...
public class WhiteSakuraParticle extends SakuraParticle {
    public WhiteSakuraParticle(SpriteSet sprite, ClientLevel level, double x, double y, double z, double motionX, double motionY, double motionZ) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double motionX, double motionY, double motionZ) {
            return new WhiteSakuraParticle(this.sprite, level, x, y, z, motionX, motionY, motionZ);
        }
    }
}
