...
public class MoeSounds extends SimpleJsonResourceReloadListener {
    ...
    private static final Map<Emotion, String> EMOTION_SOUNDS = ImmutableMap.<Emotion, String>builder()
            .put(Emotion.ANGRY, "angry")
            .put(Emotion.BEGGING, "neutral")
            .put(Emotion.CONFUSED, "confused")
            .put(Emotion.CRYING, "crying")
            .put(Emotion.MISCHIEVOUS, "snicker")
            .put(Emotion.EMBARRASSED, "attack")
            .put(Emotion.HAPPY, "giggle")
            .put(Emotion.NORMAL, "laugh")
            .put(Emotion.PAINED, "attack")
            .put(Emotion.PSYCHOTIC, "psychotic")
            .put(Emotion.SCARED, "crying")
            .put(Emotion.SICK, "sneeze")
            .put(Emotion.SNOOTY, "snooty")
            .put(Emotion.SMITTEN, "smitten")
            .put(Emotion.TIRED, "yawn")
            .build();
    ...
    protected void apply(Map<ResourceLocation, JsonElement> folder, ResourceManager resourceManager, ProfilerFiller profilerFiller) {
        ...
        for (Map.Entry<ResourceLocation, JsonElement> entry : folder.entrySet()) {
            ...
            if (block == null) {
                LOGGER.error("Parsing error loading Moe sound override: {}", location);
                continue;
            }
    ...
    public static String getEmotionSoundName(Emotion emotion) {
        return EMOTION_SOUNDS.getOrDefault(emotion, "neutral");
    }

    public static Sound getEmotionSound(Emotion emotion) {
        return Sound.fromName(getEmotionSoundName(emotion));
    }
}
