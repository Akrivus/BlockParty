...
public final class SceneFilters {
    ...
    static {
        registerAll(
                ...
                "time_period", "weather", "dimension", "biome", "altitude", "can_see_sky", "light_level", "near_block",
                "has_location", "at_location", "distance_to_location", "location_dimension",
                "has_assignment", "assignment_kind", "assignment_status", "assignment_location",
                "assignment_target_type", "distance_to_assignment", "assignment_target_present",
                "assignment_id", "has_assignment_result", "assignment_result_id",
                "assignment_result_status", "assignment_failure_reason",
                "is_available_for_routine", "seconds_since_routine", "has_active_scene", "has_active_chore",
                ...
                "self", "health", "food_level", "loyalty", "stress", "target_affection",
                "target_loyalty", "target_trust", "target_relationship_stress",
                "target_yearbook_signed", "target_phone_contact", "player_counter",
                "world_counter",
