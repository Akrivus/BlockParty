...
import block_party.scene.actions.ResetAction;
...
public class SceneActions {
    ...
    public static final RegistryObject<Factory> RESET = BlockParty.SCENE_ACTIONS.register("reset", () -> f(() -> new ResetAction()));
