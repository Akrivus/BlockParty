...
public class CustomBlocks {
    public static final RegistryObject<Block> BLANK_HANGING_SCROLL = BlockParty.BLOCKS.register("blank_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.NEVER));
    ...
    public static final RegistryObject<Block> DAWN_HANGING_SCROLL = BlockParty.BLOCKS.register("dawn_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.DAWN));
    public static final RegistryObject<Block> EVENING_HANGING_SCROLL = BlockParty.BLOCKS.register("evening_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.EVENING));
    public static final RegistryObject<Block> MIDNIGHT_HANGING_SCROLL = BlockParty.BLOCKS.register("midnight_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.MIDNIGHT));
    public static final RegistryObject<Block> MORNING_HANGING_SCROLL = BlockParty.BLOCKS.register("morning_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.MORNING));
    public static final RegistryObject<Block> NIGHT_HANGING_SCROLL = BlockParty.BLOCKS.register("night_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.NIGHT));
    public static final RegistryObject<Block> NOON_HANGING_SCROLL = BlockParty.BLOCKS.register("noon_hanging_scroll", () -> new HangingScrollBlock(Prop.SHOJI.get(), SceneFilter.NOON));
