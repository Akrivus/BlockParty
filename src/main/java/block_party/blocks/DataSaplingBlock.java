...
public final class DataSaplingBlock extends SaplingBlock implements EntityBlock {
    private final BiFunction<BlockPos, BlockState, ? extends AbstractDataBlockEntity> initializer;

    public DataSaplingBlock(
            TreeGrower treeGrower,
            BiFunction<BlockPos, BlockState, ? extends AbstractDataBlockEntity> initializer,
