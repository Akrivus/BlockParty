...
public class GinkgoTree extends AbstractTreeGrower {
    ...
    public static ConfiguredFeature build() {
        return Feature.TREE.configured(new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(BlockPartyBlocks.GINKGO_LOG.get().defaultBlockState()), new StraightTrunkPlacer(7, 1, 0), new SimpleStateProvider(BlockPartyBlocks.GINKGO_LEAVES.get().defaultBlockState()), new SimpleStateProvider(BlockPartyBlocks.GINKGO_SAPLING.get().defaultBlockState()), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 5), new TwoLayersFeatureSize(1, 0, 1)).ignoreVines().build());
    }
}
