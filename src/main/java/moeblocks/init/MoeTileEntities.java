...
public class MoeTileEntities {
    ...
    public static final RegistryObject<TileEntityType<SakuraSaplingTileEntity>> SAKURA_SAPLING = REGISTRY.register("sakura_sapling", () -> TileEntityType.Builder.create(SakuraSaplingTileEntity::new, MoeBlocks.PINK_SAKURA_SAPLING.get(), MoeBlocks.WHITE_SAKURA_SAPLING.get()).build(null));
