...
public class CellPhoneScreen extends ControllerScreen<Moe> {
    ...
    public static class ContactButton extends Button {
        public ContactButton(CellPhoneScreen parent, Moe moe) {
            super(0, 0, 81, 15, new StringTextComponent(moe.getName()), (button) -> {
                MoeMessages.send(new CNPCTeleport(moe.getID()));
                parent.closeScreen();
            });
        }
