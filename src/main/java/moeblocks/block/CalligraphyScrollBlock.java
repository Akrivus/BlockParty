...
public class CalligraphyScrollBlock extends WaypointBlock {
    ...
    public CalligraphyScrollBlock(Properties properties, RibbonColor color, TimeOfDay time) {
        super(properties, color, time);
        this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
    }

    public CalligraphyScrollBlock(Properties properties, RibbonColor color) {
