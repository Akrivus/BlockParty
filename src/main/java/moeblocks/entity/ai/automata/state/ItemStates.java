package moeblocks.entity.ai.automata.state;

import moeblocks.entity.AbstractNPCEntity;
import moeblocks.entity.MoeEntity;
import moeblocks.entity.ai.automata.IStateGoal;
import moeblocks.entity.ai.automata.State;
import moeblocks.entity.ai.goal.TryStuffItemGoal;
import moeblocks.entity.ai.goal.attack.BowAttackGoal;
import moeblocks.entity.ai.goal.items.HarvestCropsGoal;
import moeblocks.entity.ai.goal.items.MineOresGoal;
import moeblocks.entity.ai.goal.items.ReplaceCropsGoal;
import moeblocks.entity.ai.goal.target.HostileMobsTarget;
